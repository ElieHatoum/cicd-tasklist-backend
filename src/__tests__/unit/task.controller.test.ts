...
describe("TaskController", () => {
	...
	describe("createTask", () => {
		...
		it("should trim title and pass undefined description when not provided", async () => {
			mockService.create.mockResolvedValue({ ...mockTask, title: "Trimmed", description: null });
	...
	describe("updateTask", () => {
		...
		it("should return 400 for invalid id", async () => {
			const req = createMockRequest({ params: { id: "abc" }, body: { title: "X" } });
			const res = createMockResponse();
